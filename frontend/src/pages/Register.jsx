...
export default function Register() {
  ...
  return (
    <div style={{ position: "relative", display: 'flex', minHeight: '100vh', justifyContent: 'center', alignItems: 'center' }}>
      ...
      <Container className="signup" size="xs" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', padding: '20px' }}>
        <Paper padding="xl" radius="md" shadow="xs" style={{ width: '100%' }}>
          <Title order={2} align="center" mb="xl" style={{ color: 'white' }}>Регистрация</Title>
          
          <Group className="signupInputs" style={{ display: 'flex', flexDirection: 'column'}} direction="column" spacing="sm" grow>
            <TextInput
